...
function NavigationMenu({
  ...
  children,
  ...props
}: Omit<NavigationMenuPrimitive.Root.Props, "ref">) {
  return (
...
function NavigationMenuTrigger({
  ...
  children,
  ...props
}: Omit<NavigationMenuPrimitive.Trigger.Props, "ref">) {
  return (
...
function NavigationMenuContent({
  className,
  ...props
}: Omit<NavigationMenuPrimitive.Content.Props, "ref">) {
  return (
...
function NavigationMenuPositioner({
  ...
  alignOffset = 0,
  ...props
}: Omit<NavigationMenuPrimitive.Positioner.Props, "ref">) {
  return (
...
function NavigationMenuLink({
  className,
  ...props
}: Omit<NavigationMenuPrimitive.Link.Props, "ref">) {
  return (
